# HVOY Pricing Alignment Tasks

- [x] Capture live pre-change JSON and runtime data sources.
- [x] Confirm HVOY matches on `group_name` and expects `pro专属`.
- [x] Confirm internal group ID/code and real `0.2` multipliers remain intact.
- [x] Write and observe failing provider mapping tests.
