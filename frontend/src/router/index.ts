/**
 * [INPUT]: Application views, authentication/admin stores, setup state, and navigation helpers.
 * [OUTPUT]: A public activation homepage, legacy entry redirects, and guarded user/admin routes.
 * [POS]: Frontend route registry and authorization boundary.
 *
 * [PROTOCOL]:
 * 1. Keep access requirements explicit in route metadata.
 * 2. Update this header and the containing folder documentation when routes change.
 */
...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    path: '/activation',
    name: 'Activation',
    component: () => import('@/views/user/ActivationView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: false,
      title: 'Activation',
