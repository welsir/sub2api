export default {
    ...
    riskControl: {
      ...
      classifierPolicyRevision: 'Classifier Policy Revision',
      classifierPolicyRevisionHint: 'Must exactly match the revision reported by the moderation adapter readiness endpoint.',
      classifierPolicyRevisionPlaceholder: 'minimax-strict-policy-v3',
      ...
      allGroupsHint: 'Default-on moderation for every request except exempted groups',
      defaultOnGroups: 'Default-on',
      selectedGroupsHint: 'Legacy allowlist mode: only the groups selected below are moderated.',
      groupScope: 'Audit Groups',
      groupScopeHint: 'Default-on moderation covers every existing, newly created, and ungrouped request except explicitly exempted groups; switch to Selected Groups for the legacy allowlist behavior.',
      selectedGroups: 'Selected Groups',
      excludedGroups: 'Excluded groups',
      excludedGroupsHint: 'Search by name, platform, or ID and verify both name and ID before saving; groups with matching names remain independent.',
      ...
      runtimeNoExcludedGroups: 'No groups currently exempted',
      runtimeLegacyAllowlist: 'Legacy group allowlist mode is active',
