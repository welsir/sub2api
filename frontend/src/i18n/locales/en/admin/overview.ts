export default {
    ...
    users: {
      ...
      modelWhitelistHint: 'Only listed models can be used by this user. An empty list means unrestricted access.',
      addModel: 'Add Model',
      modelPlaceholder: 'e.g. gpt-5.4 or claude-*',
      modelWhitelistWildcardHint: 'A trailing * matches all models with the same prefix.',
