export default {
  ...
  admin: {
    ...
    dashboard: {
      ...
      tokenUsageTrend: 'Token 使用趋势',
      noDataAvailable: '暂无数据',
      workingDirTitle: '按工作目录的花费',
      workingDirHint: '按客户端工作目录(cwd)归集的 AI 花费，用于发现用于非公司项目的用量。Codex / Claude Code 会自动上报 cwd，其它客户端显示为未识别。',
      workingDirTotal: '合计',
      workingDirUser: '用户',
      workingDirColumn: '工作目录',
      workingDirCost: '花费',
      workingDirRequests: '请求数',
      workingDirUnknown: '（未识别）',
      model: '模型',
      group: '分组',
      noGroup: '无分组',
      requests: '请求',
    ...
    users: {
      ...
      modelWhitelistHint: '限制该用户可使用的模型。留空表示不限制，可使用全部模型。',
      addModel: '添加模型',
      modelPlaceholder: '例如 claude-sonnet-4-5 或 claude-*',
      modelWhitelistWildcardHint: '支持末尾通配符，例如 "claude-*" 匹配所有 claude 开头的模型。',
      allowedModelsList: '已允许的模型',
      modelWhitelistEmpty: '未设置白名单：该用户可使用全部模型。',
      modelWhitelistUpdated: '模型白名单更新成功',
      weeklyThreshold: '周花费阈值',
      weeklyThresholdHint: '当该用户在一个自然周（周六至周五）内的实际花费达到阈值时告警（邮件通知用户与管理员），不阻断请求。',
      weeklyThresholdLabel: '周花费阈值（美元）',
      weeklyThresholdPlaceholder: '例如 50',
      weeklyThresholdNoLimit: '留空或填 0 表示不限制（不告警）。',
      weeklyThresholdCurrent: '当前阈值',
      weeklyThresholdUnlimited: '不限制',
      weeklyThresholdUpdated: '周花费阈值更新成功',
      replaceGroup: '替换分组',
    ...
    settings: {
      ...
      payment: {
        ...
        balancePaymentDisabledHint: '开启后所有用户都不能购买余额包',
        balanceRequiresActiveSubscription: '余额包需有效订阅',
        balanceRequiresActiveSubscriptionHint: '开启后，用户必须先开通订阅套餐，才能购买余额包',
        noLimit: '留空表示不限制',
        helpImage: '帮助图片',
  ...
  payment: {
    ...
    errors: {
      ...
      SUBSCRIPTION_REQUIRED: '请先开通有效订阅后再继续',
	      INVALID_AMOUNT: '金额无效',
      INVALID_INPUT: '参数有误',
