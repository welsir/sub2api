export default {
  ...
  admin: {
    ...
    dashboard: {
      ...
      accountCost: 'Cost',
      noDataAvailable: 'No data available',
      workingDirTitle: 'Spend by Working Directory',
      workingDirHint: 'AI cost attributed to the client working directory (cwd). Helps spot usage on non-company projects. Codex / Claude Code report cwd automatically; other clients show as unidentified.',
      workingDirTotal: 'Total',
      workingDirUser: 'User',
      workingDirColumn: 'Working Directory',
      workingDirCost: 'Cost',
      workingDirRequests: 'Requests',
      workingDirUnknown: '(unidentified)',
      recentUsage: 'Recent Usage',
    ...
    users: {
      ...
      modelWhitelistHint: 'Restrict which models this user may use. Leave empty for no restriction (all models allowed).',
      addModel: 'Add Model',
      modelPlaceholder: 'e.g. claude-sonnet-4-5 or claude-*',
      modelWhitelistWildcardHint: 'A trailing "*" wildcard is supported, e.g. "claude-*" matches all models starting with claude.',
      allowedModelsList: 'Allowed Models',
      modelWhitelistEmpty: 'No whitelist set: this user may use all models.',
      modelWhitelistUpdated: 'Model whitelist updated successfully',
      weeklyThreshold: 'Weekly Spend Limit',
      weeklyThresholdHint: 'Warn (email to the user and admins) when this user\'s actual cost reaches the limit within a natural week (Sat–Fri). Does not block requests.',
      weeklyThresholdLabel: 'Weekly spend limit (USD)',
      weeklyThresholdPlaceholder: 'e.g. 50',
      weeklyThresholdNoLimit: 'Leave empty or 0 for no limit (no alert).',
      weeklyThresholdCurrent: 'Current limit',
      weeklyThresholdUnlimited: 'No limit',
      weeklyThresholdUpdated: 'Weekly spend limit updated successfully',
    ...
    settings: {
      ...
      payment: {
        ...
        balancePaymentDisabledHint: 'When enabled, users cannot buy balance packages.',
        balanceRequiresActiveSubscription: 'Require active subscription for balance packages',
        balanceRequiresActiveSubscriptionHint: 'When enabled, users must subscribe before buying balance packages.',
