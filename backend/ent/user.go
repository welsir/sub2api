...
type UserEdges struct {
	...
	// ActivationJourney holds the value of the activation_journey edge.
	ActivationJourney *UserActivationJourney `json:"activation_journey,omitempty"`
...
// ActivationJourneyOrErr returns the ActivationJourney value or an error if the edge
// was not loaded in eager-loading, or loaded but was not found.
func (e UserEdges) ActivationJourneyOrErr() (*UserActivationJourney, error) {
	if e.ActivationJourney != nil {
		return e.ActivationJourney, nil
	} else if e.loadedTypes[13] {
		return nil, &NotFoundError{label: useractivationjourney.Label}
	}
	return nil, &NotLoadedError{edge: "activation_journey"}
}
...
// QueryActivationJourney queries the "activation_journey" edge of the User entity.
func (_m *User) QueryActivationJourney() *UserActivationJourneyQuery {
	return NewUserClient(_m.config).QueryActivationJourney(_m)
}
