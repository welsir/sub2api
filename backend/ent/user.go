...
type User struct {
	...
	// Per-user model whitelist; empty means unrestricted
	AllowedModels []string `json:"allowed_models,omitempty"`
	// Per-user weekly actual_cost threshold; Saturday is the first day
	WeeklyCostThreshold *float64 `json:"weekly_cost_threshold,omitempty"`
	// Start date of the last natural week whose threshold notification was claimed
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldBalance, user.FieldFrozenBalance, user.FieldBalanceNotifyThreshold, user.FieldTotalRecharged, user.FieldWeeklyCostThreshold:
