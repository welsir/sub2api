...
type GroupEdges struct {
	...
	// SelectedAPIKeys holds the value of the selected_api_keys edge.
	SelectedAPIKeys []*APIKey `json:"selected_api_keys,omitempty"`
...
// SelectedAPIKeysOrErr returns the SelectedAPIKeys value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) SelectedAPIKeysOrErr() ([]*APIKey, error) {
	if e.loadedTypes[6] {
		return e.SelectedAPIKeys, nil
	}
	return nil, &NotLoadedError{edge: "selected_api_keys"}
}
...
// QuerySelectedAPIKeys queries the "selected_api_keys" edge of the Group entity.
func (_m *Group) QuerySelectedAPIKeys() *APIKeyQuery {
	return NewGroupClient(_m.config).QuerySelectedAPIKeys(_m)
}
