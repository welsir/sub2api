...
var (
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "provider_pricing_enabled", Type: field.TypeBool, Default: false},
		{Name: "provider_pricing_group_name", Type: field.TypeString, Size: 100, Default: ""},
		{Name: "provider_pricing_models", Type: field.TypeJSON, SchemaType: map[string]string{"postgres": "jsonb"}},
