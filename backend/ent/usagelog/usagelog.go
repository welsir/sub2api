...
var (
	...
	// WorkingDirectoryValidator is a validator for the "working_directory" field. It is called by the builders before save.
	WorkingDirectoryValidator func(string) error
