...
type APIKeyEdges struct {
	...
	// SelectedGroups holds the value of the selected_groups edge.
	SelectedGroups []*Group `json:"selected_groups,omitempty"`
...
// SelectedGroupsOrErr returns the SelectedGroups value or an error if the edge
// was not loaded in eager-loading.
func (e APIKeyEdges) SelectedGroupsOrErr() ([]*Group, error) {
	if e.loadedTypes[2] {
		return e.SelectedGroups, nil
	}
	return nil, &NotLoadedError{edge: "selected_groups"}
}
...
// QuerySelectedGroups queries the "selected_groups" edge of the APIKey entity.
func (_m *APIKey) QuerySelectedGroups() *GroupQuery {
	return NewAPIKeyClient(_m.config).QuerySelectedGroups(_m)
}
