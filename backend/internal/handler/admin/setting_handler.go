...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		PaymentBalanceRequiresActiveSubscription: paymentCfg.BalanceRequiresActiveSubscription,
...
type UpdateSettingsRequest struct {
	...
	PaymentBalanceRequiresActiveSubscription *bool    `json:"payment_balance_requires_active_subscription"`
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	if h.paymentConfigService != nil && hasPaymentFields(req) {
		paymentReq := service.UpdatePaymentConfigRequest{
			...
			BalanceRequiresActiveSubscription: req.PaymentBalanceRequiresActiveSubscription,
	...
	payload := dto.SystemSettings{
		...
		PaymentBalanceRequiresActiveSubscription: updatedPaymentCfg.BalanceRequiresActiveSubscription,
...
func hasPaymentFields(req UpdateSettingsRequest) bool {
	return req.PaymentEnabled != nil || req.PaymentMinAmount != nil ||
		...
		req.PaymentBalanceRequiresActiveSubscription != nil || req.PaymentBalanceRechargeMultiplier != nil || req.PaymentRechargeFeeRate != nil ||
