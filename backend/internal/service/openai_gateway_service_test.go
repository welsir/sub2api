...
func TestOpenAIBuildUpstreamRequestOpenAIPassthroughCompressesLargeOAuthStreamBody(t *testing.T) {
	gin.SetMode(gin.TestMode)
	...
	req, err := svc.buildUpstreamRequestOpenAIPassthrough(c.Request.Context(), c, &Account{Type: AccountTypeOAuth}, body, "token")
	require.NoError(t, err)
