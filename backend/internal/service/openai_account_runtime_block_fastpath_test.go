...
func TestOpenAIPoolModeTempRule_StopsSameAccountRetryAndIsolatesBlockToModel(t *testing.T) {
	...
	require.False(t, gateway.isOpenAIAccountRuntimeBlocked(account))
	require.False(t, gateway.isOpenAIAccountRequestRuntimeBlocked(context.Background(), account, "gpt-5.5", false))
}
...
func TestOpenAIPoolModeRetryable5xx_DoesNotCreateModelTransientBlock(t *testing.T) {
	...
	require.False(t, gateway.isOpenAIAccountRequestRuntimeBlocked(context.Background(), account, "gpt-5.4", false))
}
...
func TestOpenAIPoolModeNonRetryable5xx_StillCreatesModelTransientBlock(t *testing.T) {
	...
	require.True(t, gateway.isOpenAIAccountRequestRuntimeBlocked(context.Background(), account, "gpt-5.4", false))
}
...
func TestRuntimeBlockHonorsClearedPersistedCooldown(t *testing.T) {
	...
	require.False(t, svc.isOpenAIAccountRequestRuntimeBlocked(context.Background(), account, "grok-3", false))
	require.False(t, svc.isOpenAIAccountRuntimeBlocked(account))
}
...
func TestRuntimeBlockKeepsActivePersistedCooldown(t *testing.T) {
	...
	require.True(t, svc.isOpenAIAccountRequestRuntimeBlocked(context.Background(), account, "grok-3", false))
	require.True(t, svc.isOpenAIAccountRuntimeBlocked(account))
}
