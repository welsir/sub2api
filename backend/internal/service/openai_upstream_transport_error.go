...
//  2. leaves account scheduling state untouched because proxy/network failures
//     describe infrastructure state, not account health;
...
//     context.Canceled (client gone — no failover).
//
